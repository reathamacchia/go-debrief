...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "debrief.ipc", false, filepath.Join(os.TempDir(), "debrief.ipc")},
		{"data", "debrief.ipc", false, "data/debrief.ipc"},
		{"data", "./debrief.ipc", false, "./debrief.ipc"},
		{"data", "/debrief.ipc", false, "/debrief.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "debrief.ipc", true, `\\.\pipe\debrief.ipc`},
		{"data", "debrief.ipc", true, `\\.\pipe\debrief.ipc`},
		{"data", `\\.\pipe\debrief.ipc`, true, `\\.\pipe\debrief.ipc`},
	}
