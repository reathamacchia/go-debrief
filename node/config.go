...
import (
	...
	"github.com/Debrief-BC/go-debrief/accounts/external"
	"github.com/Debrief-BC/go-debrief/accounts/keystore"
	"github.com/Debrief-BC/go-debrief/accounts/scwallet"
	"github.com/Debrief-BC/go-debrief/accounts/usbwallet"
...
func (c *Config) NodeName() string {
	name := c.name()
	// Backwards compatibility: previous versions used title-cased "Debrief", keep that.
	if name == "debrief" || name == "debrief-testnet" {
		name = "Debrief"
	}
	if c.UserIdent != "" {
		name += "/" + c.UserIdent
